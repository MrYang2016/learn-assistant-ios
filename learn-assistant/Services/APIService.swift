...
class APIService {
    ...
    func getKnowledgePoints(accessToken: String, limit: Int = 20, offset: Int = 0) async throws -> [KnowledgePoint] {
    ...
    func createKnowledgePoint(accessToken: String, question: String, answer: String, isInReviewPlan: Bool = true) async throws -> KnowledgePoint {
        ...
        let body = CreateKnowledgePointRequest(question: question, answer: answer, isInReviewPlan: isInReviewPlan)
        request.httpBody = try JSONEncoder().encode(body)
    ...
    func updateKnowledgePoint(accessToken: String, id: String, question: String, answer: String, isInReviewPlan: Bool? = nil) async throws -> KnowledgePoint {
        ...
        let body = UpdateKnowledgePointRequest(question: question, answer: answer, isInReviewPlan: isInReviewPlan)
        request.httpBody = try JSONEncoder().encode(body)
    ...
    func sendChatMessage(accessToken: String, message: String, history: [ChatHistoryMessage]? = nil) async throws -> ChatResponse {
